...
const TOKEN_SALE_ADDRESS =
  "0x6a9b64d39cf2543f80c752a9670a8477c1a6db5c" as `0x${string}`;
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-neutral-50 via-neutral-300 to-neutral-50 text-graphite-900 p-6 pt-24 md:p-12 font-sans">
      ...
      <section className="max-w-4xl mx-auto mb-12 text-center">
        ...
        <h2 className="font-display text-2xl lg:text-3xl font-extrabold tracking-tight mb-4 text-petroleum-900">
          Join the unfolding movement
        </h2>
        <p className="text-lg md:text-xl max-w-3xl mx-auto text-graphite-900">
          Secure your DGT3 tokens by connecting your wallet, completing KYC,
          approving USDT, and buying tokens in a few easy steps.
        </p>
      </section>
      ...
      <section className="max-w-xl mx-auto rounded-lg p-8 space-y-6 bg-neutral-100">
        ...
        <div className="mt-6 space-y-2 text-sm text-graphite-900">
          <p>
            <span
              className={`inline-block w-3 h-3 mr-2 rounded-full ${
                isConnected ? "bg-petroleum-500" : "bg-red-500"
              }`}
            />
          ...
          <p>
            <span
              className={`inline-block w-3 h-3 mr-2 rounded-full ${
                isKycCompleted ? "bg-petroleum-500" : "bg-neutral-500"
              }`}
            />
        ...
        {phases.map(
          ({ title, description, price, bonus, duration, bgColor }) => (
            ...
            >
              ...
              <p className="mb-4 text-neutral-100 font-semibold">
                {description}
              </p>
      ...
      <section className="max-w-4xl mx-auto mt-16 mb-12 px-4 text-neutral-400 text-sm leading-relaxed">
        <h2 className="text-petroleum-900 font-semibold mb-2">
          Legal & Compliance
        </h2>
        <p>
          Participation in the DGT3 token sale is subject to compliance with
          applicable laws and regulations. By participating, you confirm that
          you have completed all required KYC/AML checks and are eligible to
          purchase tokens in your jurisdiction. The DGT Energy team is not
          responsible for any legal or financial consequences resulting from
          non-compliance. Please consult your legal advisor before
          participating.
        </p>
      </section>
    </main>
