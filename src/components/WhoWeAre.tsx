...
export const WhoWeAre = () => {
  return (
    <section className="relative flex flex-col items-center py-8 lg:px-6 bg-neutral-100 text-energy-gray">
      <h2 className="text-3xl md:text-4xl font-display font-bold mb-6 text-energy-blue">
        Who We Are
      </h2>
      <div className="flex items-start lg:justify-center gap-8 w-full px-12 overflow-auto py-8">
